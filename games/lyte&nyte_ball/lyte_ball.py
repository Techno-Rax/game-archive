...
# Title And Logo
pygame.display.set_caption("Light Ball")
icon = pygame.image.load("data/icon.png")
pygame.display.set_icon(icon)

# Background
background = pygame.image.load('data/baccground.png')
...
# ball
ballimg = pygame.image.load('data/Lite-Ball.png')
bally = 468
ballx = 235
ball_change = -1.5
...
while run:
	...
	if bally < 0:
		for i in range(1, 10):
			...
			d3 = random.randint(2, 4)
			d4 = random.randint(2, 4)
